var app = (function () {
    ...
    // (25:4) {#each allRolls as roll}
    function create_each_block(ctx) {
    	let p;
    	let t_value = /*roll*/ ctx[3] + "";
    	let t;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*allRolls*/ 1 && t_value !== (t_value = /*roll*/ ctx[3] + "")) set_data(t, t_value);
    		},
    		d(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor, remount) {
    			...
    			if (remount) dispose();
    			dispose = listen(button, "click", /*requestRoll*/ ctx[1]);
    		},
    		p(ctx, [dirty]) {
    			if (dirty & /*allRolls*/ 1) {
    				each_value = /*allRolls*/ ctx[0];
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	connection.on("update", function (registry) {
    		$$invalidate(0, allRolls = registry);
    	});
    	...
    	return [allRolls, requestRoll, connection];
    }

    class App extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { connection: 2 });
    	}
    }
