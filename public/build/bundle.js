var app = (function () {
    ...
    /* svelte-app\components\Roller.svelte generated by Svelte v3.20.1 */

    function get_each_context(ctx, list, i) {
    	const child_ctx = ctx.slice();
    	child_ctx[0] = list[i].name;
    	child_ctx[4] = list[i].roll;
    	return child_ctx;
    }

    // (29:4) {#each allRolls as { name, roll }}
    function create_each_block(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*allRolls*/ 2 && t0_value !== (t0_value = /*name*/ ctx[0] + "")) set_data(t0, t0_value);
    			if (dirty & /*allRolls*/ 2 && t2_value !== (t2_value = /*roll*/ ctx[4] + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			div1 = element("div");
    			h1 = element("h1");
    			h1.textContent = "RocanRoller!";
    			t1 = space();
    			button = element("button");
    			t2 = text("Test Your Luck, ");
    			t3 = text(/*name*/ ctx[0]);
    			t4 = space();
    			div0 = element("div");
    			...
    			attr(h1, "class", "svelte-1kdh87v");
    			attr(div0, "class", "registry");
    			attr(div1, "class", "roller svelte-1kdh87v");
    		},
    		m(target, anchor, remount) {
    			...
    			if (remount) dispose();
    			dispose = listen(button, "click", /*requestRoll*/ ctx[2]);
    		},
    		p(ctx, [dirty]) {
    			if (dirty & /*name*/ 1) set_data(t3, /*name*/ ctx[0]);

    			if (dirty & /*allRolls*/ 2) {
    				each_value = /*allRolls*/ ctx[1];
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { connection } = $$props, { name } = $$props;
    	let allRolls = [];
    	...
    	connection.on("update", function (registry) {
    		$$invalidate(1, allRolls = registry);
    	});

    	$$self.$set = $$props => {
    		if ("connection" in $$props) $$invalidate(3, connection = $$props.connection);
    		if ("name" in $$props) $$invalidate(0, name = $$props.name);
    	};

    	return [name, allRolls, requestRoll, connection];
    }

    class Roller extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { connection: 3, name: 0 });
    	}
    }

    /* svelte-app\components\SignIn.svelte generated by Svelte v3.20.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(input, "placeholder", "What is your name?");
    			attr(form, "class", "svelte-4glbe3");
    		},
    		m(target, anchor, remount) {
    			...
    			dispose = [
    				...
    				listen(form, "submit", /*setName*/ ctx[1])
    			];
    		},
    		p(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [name, setName, connection, input_input_handler];
    }

    class SignIn extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { connection: 2 });
    	}
    }

    /* svelte-app\App.svelte generated by Svelte v3.20.1 */
    ...
    function create_else_block(ctx) {
    	...
    	const signin = new SignIn({
    			props: { connection: /*connection*/ ctx[0] }
    		});
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*connection*/ 1) signin_changes.connection = /*connection*/ ctx[0];
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<h1>Reconnecting...</h1>`;
    			attr(div, "class", "svelte-8uosrt");
    		},
    		m(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			mount_component(roller, target, anchor);
    			current = true;
    		},
    		p(ctx, dirty) {
    			const roller_changes = {};
    			if (dirty & /*connection*/ 1) roller_changes.connection = /*connection*/ ctx[0];
    			if (dirty & /*name*/ 4) roller_changes.name = /*name*/ ctx[2];
    			roller.$set(roller_changes);
    		},
    		i(local) {
    			if (current) return;
    		...
    		d(detaching) {
    			destroy_component(roller, detaching);
    		}
    	};
    }

    // (80:4) {#each users as user}
    function create_each_block$1(ctx) {
    	let p;
    	let t_value = /*user*/ ctx[4] + "";
    	let t;
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*users*/ 2 && t_value !== (t_value = /*user*/ ctx[4] + "")) set_data(t, t_value);
    		},
    		d(detaching) {
    			if (detaching) detach(p);
    		}
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "main svelte-8uosrt");
    			attr(div1, "class", "users svelte-8uosrt");
    			attr(div2, "class", "app svelte-8uosrt");
    		},
    		m(target, anchor) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	connection.on("reconnecting", function () {
    		$$invalidate(3, error = "Reconnecting...");
    	});

    	connection.on("error", function () {
    		$$invalidate(3, error = "Disconnected!");
    	});
    	...
    	return [connection, users, name, error];
    }

    class App extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { connection: 0 });
    	}
    }
